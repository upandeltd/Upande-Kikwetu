    ...
    },
    {
        ...
        "filters": [
            ["name", "in", ["Delivery Note Script", "CPL complete percentage tracker", "Material Transfer Submit",
                            ...
                            "Harvest Stock Entry", "Stock Entry Script", "Stock Entry After Save","Get Pick List with Farm Packlist","Packed% on FPL","Completeness tracker CPL","Credit Limit Alert","UpdateBucketStatus","FetchGreenhouseByBucketId","RFQ Send CC Emails","createOrUpdateFarmPackList","loadTruck","Farm Code on Sales Order","Calculate Total Amount In Material Request"]]
        ]
    },
    {
        "dt": "DocType",
        "filters": [
            ["name", "in", ["Box Label", "Box Label Item", "Breeders", "Bunch QR Code",
                            ...
                            "Scan Check", "Scan Check List", "Scan Location", "Scanned Items", "Stem Length","Harvest Rejects","Harvest Reject Items","Truck Loading Manifest","Box Details"
